    ...
    return (
        <Content>
           <div className={'title'}>SMS</div>
            ...
            <div className={'login-wrap'}>
                <div className={'input-phone-inner'}>
                    <InputItem
                        type="tel"
                        maxLength='12'
                        onChange={(e) => props.changeInputPhoneDispatch(e)}
                ...
                <div className={'input-code-inner'}>
                    ...
                    <Button  className={'send-btn'} onClick={() => props.clickGetCodeByPhone(props.phone)}>Get OTP</Button>
                </div>
                <div className={'input-desc-gree'}>
                    <AgreeItem data-seed="logId"
                               onChange={ (v) => props.greeCheckDispatch(v)}>
                             <a onClick={(e) => props.readPricacyeDispatch(e) }
            ...
            <div className={'login-submit-btn'} onClick={ () => props.checkLoginDispatch({...props }) }>Login to get loans</div>
        </Content>
    )
}
